...
public class Swagger {
	private static final String title = "customer intake API";
	private static final String description = "API for Customer data load";
	...
	public Docket intakeApi() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.paths(PathSelectors.regex("/v1/customers.*"))
				.build()
				.apiInfo(metaData());
